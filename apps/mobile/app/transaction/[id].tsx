...
export default function TransactionDetailScreen() {
  ...
  return (
    <View
      style={[
        styles.container,
        { backgroundColor: colorScheme === "dark" ? "#111827" : "#2D4BFF" },
      ]}
    >
      ...
      >
        <View style={styles.headerTop}>
          ...
          <Text style={styles.headerTitle}>
            {isEditing ? t("transaction.editTitle") : t("transaction.details")}
          </Text>
          {!isEditing ? (
            <TouchableOpacity
              style={styles.iconButton}
            ...
            >
              <Ionicons
                name="trash-outline"
                size={24}
                color={colorScheme === "dark" ? "#EF4444" : "#FF6F61"}
              />
            </TouchableOpacity>
          ) : (
            <View style={{ width: 40 }} />
      ...
      {/* Main Content */}
      <View
        style={[styles.whiteSection, { backgroundColor: colors.background }]}
      >
        <ScrollView
            ...
            {isEditing ? (
              <View
                style={[
                  ...
                  {
                    borderBottomColor:
                      colorScheme === "dark" ? "#586EEF" : "#2D4BFF",
                  },
                ]}
              >
              ...
              <Text style={[styles.amountText, { color: colors.text }]}>
                ${" "}
                {Number(transaction.amount).toLocaleString(i18n.language, {
          ...
          <View style={styles.detailsList}>
            ...
            <View style={styles.detailRow}>
              <Text style={styles.detailLabel}>
                {isIncome ? t("transaction.from") : t("transaction.to")}
              </Text>
              {isEditing ? (
                <TextInput
                  style={[
                    ...
                    {
                      color: colorScheme === "dark" ? "#E0E7FF" : "#2D4BFF",
                      backgroundColor:
                        colorScheme === "dark" ? "#1E293B" : "#F3F6FF",
                    },
                  ]}
                  value={editCategory}
            ...
            <View style={styles.detailRow}>
              ...
              {isEditing ? (
                <TouchableOpacity onPress={() => setShowDatePicker(true)}>
                  ...
                  >
                    {editDate.toLocaleDateString(i18n.language, {
                      month: "short",
                      day: "numeric",
                      year: "numeric",
                    })}
            ...
            <View style={styles.detailRow}>
              ...
              <Text style={[styles.detailValue, { color: colors.text }]}>
                {dateObj.toLocaleTimeString(i18n.language, {
                  hour: "2-digit",
                  minute: "2-digit",
                })}
              </Text>
            ...
            <DetailRow
              label={
                isIncome ? t("transaction.earnings") : t("transaction.spending")
              }
              value={`$ ${
                isEditing
            ...
            {isEditing ? (
              <View
                style={styles.editAttachmentSection}
                id="edit-attachment-section"
              >
                {editAttachment ? (
                  <View
                    style={[
                      styles.attachmentPreviewChip,
                      {
                        backgroundColor:
                          colorScheme === "dark" ? "#1E293B" : "#F3F6FF",
                        borderColor:
                          colorScheme === "dark" ? "#334155" : "#D1D5DB",
                      },
                    ]}
                  >
                    {editAttachment.type.includes("image") ? (
                      <RNImage
                        source={{ uri: editAttachment.uri }}
                        style={{
                          width: 40,
                          height: 40,
                          borderRadius: 8,
                  ...
                  <View style={styles.attachmentActionRow}>
                    <TouchableOpacity
                      style={[
                        ...
                        {
                          backgroundColor:
                            colorScheme === "dark" ? "#1E293B" : "#F9FAFB",
                          borderColor:
                ...
                {transaction.attachmentType === "PDF" ? (
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          colorScheme === "dark" ? "#1E293B" : "#FFF5F5",
                        borderColor:
                          colorScheme === "dark" ? "#7f1d1d" : "#FEE2E2",
                      },
                    ]}
                    onPress={() => Linking.openURL(transaction.attachmentUrl)}
                  >
            ...
            <View style={styles.buttonGroup}>
              <TouchableOpacity
                style={[
                  styles.actionBtn,
                  styles.saveBtn,
                  colorScheme === "dark" && { backgroundColor: "#586EEF" },
                ]}
                onPress={handleSave}
                disabled={isSaving}
              >
          ...
          >
            <View
              style={[
                ...
                {
                  backgroundColor:
                    colorScheme === "dark" ? "#451a1a" : "#FFF5F5",
                },
              ]}
            >
  ...
  return (
    <View style={styles.detailRow}>
      ...
      <Text
        style={[
          styles.detailValue,
          { color: textColor, fontWeight: isBold ? "700" : "600" },
        ]}
      >
        {value}
      </Text>
